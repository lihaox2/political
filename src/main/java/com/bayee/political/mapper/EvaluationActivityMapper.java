...
public interface EvaluationActivityMapper {
    ...
    int insert(EvaluationActivity record);

    int insertSelective(EvaluationActivity record);

    EvaluationActivity selectByPrimaryKey(Integer id);

    int updateByPrimaryKeySelective(EvaluationActivity record);
