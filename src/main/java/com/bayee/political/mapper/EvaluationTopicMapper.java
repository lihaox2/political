...
public interface EvaluationTopicMapper {
    ...
    int insert(EvaluationTopic record);

    int insertSelective(EvaluationTopic record);

    EvaluationTopic selectByPrimaryKey(Integer id);

    int updateByPrimaryKeySelective(EvaluationTopic record);
