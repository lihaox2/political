...
public interface RiskConductBureauRuleTypeService {
     ...
     * @return
     */
    List<RiskConductBureauRuleType> riskConductBureauRuleTypePage(Integer pageIndex, Integer pageSize,String type,String key);

    /**
     * 统计数据条数
     * @return
     */
    Integer getRiskConductBureauRuleTypePageCount(String type,String key);
