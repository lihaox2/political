...
public class JsonUtils {
	...
	/**
	 * <pre>
	 * 从json字符串中解析出一个对象的集合，被解析字符串要求是合法的集合类型 （形如:["k1":"v1","k2":"v2",..."kn":"vn"]）
	 * 
	...
	/**
	 * <pre>
	 * 从json字符串中按照路径寻找，并解析出一个对象的集合，例如： 类Person有一个属性name，要从以下json中解析出其集合： {
	 * "page_info":{ "items":{
	...
	/**
	 * <pre>
	 * 有些json的常见格式错误这里可以处理，以便给后续的方法处理 常见错误：使用了\" 或者 "{ 或者 }"，腾讯的页面中常见这种格式
	 * 
