...
public class SelectExcel {
	...
	private String[] breakDownNames;
	private String[] sonBreakDownNames;
	
	public SelectExcel(String[] itemNames, String[] months, String[] breakDownNames, String[] sonBreakDownNames) {
		super(); 
		this.itemNames = itemNames;
		this.months = months;
		this.breakDownNames = breakDownNames;
		this.sonBreakDownNames = sonBreakDownNames;
	}
	 ...
	 * 创建一个excel文件
	 */
	private Workbook createWorkBoot(String title, String[] excelHeader, List<Map<String, Object>> list,
			String[] keys) {
	 ...
	 * @param cellCount
	 */
	private void setSelect(Cell cell, Sheet sheet, int rowCount, int cellCount) {
    	
    	switch(cellCount) {
    		case 0:
    		//考评类型
    			setSelect(sheet, rowCount, cellCount, new String[] {"负面考评","正面考评", "中性考评"});
    		break;
    		case 1:
        	//记分项目
    			setSelect(sheet, rowCount, cellCount, itemNames);
        	break;
    		case 4:
            //公安月
    			setSelect(sheet, rowCount, cellCount, months);	
            break;
    		case 5:
            //记分细目
    			setSelect(sheet, rowCount, cellCount, breakDownNames);		
            break;
    		case 6:
            //记分子细目
    			setSelect(sheet, rowCount, cellCount, sonBreakDownNames);		
            break;
    	}
	 ...
	 * 设置下拉选项
	 */
	private void setSelect(Sheet sheet, int rowCount, int cellCount, String[] str) {
	...
	/** 设置字体大小，颜色，样式，是否加粗 */
	private Font createFont(Workbook workbook, short fontHeightInPoints, boolean isBlod) {
